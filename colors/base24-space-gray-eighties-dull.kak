...
declare-option str base01 'rgb:15171c'
declare-option str base02 'rgb:555555'
declare-option str base03 'rgb:6c6d70'
declare-option str base04 'rgb:83868b'
declare-option str base05 'rgb:9a9fa6'
declare-option str base06 'rgb:b2b8c2'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:b14956'
declare-option str base09 'rgb:c6725a'
declare-option str base0A 'rgb:5485c0'
declare-option str base0B 'rgb:91b377'
declare-option str base0C 'rgb:7fcccb'
declare-option str base0D 'rgb:7b8fa4'
declare-option str base0E 'rgb:a5779e'
declare-option str base0F 'rgb:58242b'
declare-option str base10 'rgb:383838'
declare-option str base11 'rgb:1c1c1c'
declare-option str base12 'rgb:ec5f67'
declare-option str base13 'rgb:fdc253'
declare-option str base14 'rgb:88e985'
declare-option str base15 'rgb:58c2c0'
declare-option str base16 'rgb:5485c0'
declare-option str base17 'rgb:bf83c0'
