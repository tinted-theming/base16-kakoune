...
declare-option str base00 'rgb:2a3b4d'
declare-option str base01 'rgb:3d566f'
declare-option str base02 'rgb:4b6988'
declare-option str base03 'rgb:55799c'
declare-option str base04 'rgb:7e90a3'
declare-option str base05 'rgb:9fa2a6'
declare-option str base06 'rgb:d6d7d9'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:c4676c'
declare-option str base09 'rgb:ff9966'
declare-option str base0A 'rgb:ffff66'
declare-option str base0B 'rgb:66ff66'
declare-option str base0C 'rgb:4b8f77'
declare-option str base0D 'rgb:15f4ee'
declare-option str base0E 'rgb:9c6cd3'
declare-option str base0F 'rgb:bb64a9'
