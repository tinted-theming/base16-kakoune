...
declare-option str base00 'rgb:faf0dc'
declare-option str base01 'rgb:c8c8c8'
declare-option str base02 'rgb:888888'
declare-option str base03 'rgb:585858'
declare-option str base04 'rgb:282828'
declare-option str base05 'rgb:181818'
declare-option str base06 'rgb:000000'
declare-option str base07 'rgb:000000'
declare-option str base08 'rgb:de5d6e'
declare-option str base09 'rgb:ff9470'
declare-option str base0A 'rgb:b3684f'
declare-option str base0B 'rgb:76a85d'
declare-option str base0C 'rgb:64b5a7'
declare-option str base0D 'rgb:5890f8'
declare-option str base0E 'rgb:c173d1'
declare-option str base0F 'rgb:b3684f'
