...
declare-option str base00 'rgb:1f2022'
declare-option str base01 'rgb:282828'
declare-option str base02 'rgb:444155'
declare-option str base03 'rgb:585858'
declare-option str base04 'rgb:b8b8b8'
declare-option str base05 'rgb:a3a3a3'
declare-option str base06 'rgb:e8e8e8'
declare-option str base07 'rgb:f8f8f8'
declare-option str base08 'rgb:f2241f'
declare-option str base09 'rgb:ffa500'
declare-option str base0A 'rgb:b1951d'
declare-option str base0B 'rgb:67b11d'
declare-option str base0C 'rgb:2d9574'
declare-option str base0D 'rgb:4f97d7'
declare-option str base0E 'rgb:a31db1'
declare-option str base0F 'rgb:b03060'
