...
declare-option str base00 'rgb:171517'
declare-option str base01 'rgb:1b181b'
declare-option str base02 'rgb:1d1b1d'
declare-option str base03 'rgb:383338'
declare-option str base04 'rgb:e7dbdb'
declare-option str base05 'rgb:f5f5f5'
declare-option str base06 'rgb:ffffff'
declare-option str base07 'rgb:f7f3f7'
declare-option str base08 'rgb:ffa600'
declare-option str base09 'rgb:00ff66'
declare-option str base0A 'rgb:20df6c'
declare-option str base0B 'rgb:ff0066'
declare-option str base0C 'rgb:6600ff'
declare-option str base0D 'rgb:00ffff'
declare-option str base0E 'rgb:007fff'
declare-option str base0F 'rgb:df206c'
