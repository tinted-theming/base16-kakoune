...
declare-option str base00 'rgb:fbfbfd'
declare-option str base01 'rgb:f6f6f8'
declare-option str base02 'rgb:d8e2ec'
declare-option str base03 'rgb:b7c5d3'
declare-option str base04 'rgb:526270'
declare-option str base05 'rgb:28323a'
declare-option str base06 'rgb:1d252c'
declare-option str base07 'rgb:171d23'
declare-option str base08 'rgb:8c4351'
declare-option str base09 'rgb:965027'
declare-option str base0A 'rgb:8f5e15'
declare-option str base0B 'rgb:33635c'
declare-option str base0C 'rgb:0f4b6e'
declare-option str base0D 'rgb:34548a'
declare-option str base0E 'rgb:5a4a78'
declare-option str base0F 'rgb:7e5140'
