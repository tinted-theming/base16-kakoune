...
declare-option str base01 'rgb:323449'
declare-option str base02 'rgb:3b4261'
declare-option str base03 'rgb:7081d0'
declare-option str base04 'rgb:a1abe0'
declare-option str base05 'rgb:ebfafa'
declare-option str base06 'rgb:f0f2f4'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:f16c75'
declare-option str base09 'rgb:f7c67f'
declare-option str base0A 'rgb:f1fc79'
declare-option str base0B 'rgb:37f499'
declare-option str base0C 'rgb:04d1f9'
declare-option str base0D 'rgb:39ddfd'
declare-option str base0E 'rgb:a48cf2'
declare-option str base0F 'rgb:f265b5'
declare-option str base10 'rgb:171928'
declare-option str base11 'rgb:0e0f1a'
declare-option str base12 'rgb:f89a9d'
declare-option str base13 'rgb:f9e9a1'
declare-option str base14 'rgb:6fffc1'
declare-option str base15 'rgb:6ce9ff'
declare-option str base16 'rgb:7ae9ff'
declare-option str base17 'rgb:d4b3ff'
