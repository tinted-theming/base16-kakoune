...
#
# Authors:
# Scheme: Michaël Ball, based on Tokyo Night by enkia (https://github.com/enkia/tokyo-night-vscode-theme)
# Template: Jamy Golden (https://github.com/JamyGolden)

# palette

declare-option str base00 'rgb:222436'
declare-option str base01 'rgb:1e2030'
declare-option str base02 'rgb:2f334d'
declare-option str base03 'rgb:444a73'
declare-option str base04 'rgb:828bb8'
declare-option str base05 'rgb:c8d3f5'
declare-option str base06 'rgb:b4c2f0'
declare-option str base07 'rgb:c8d3f5'
declare-option str base08 'rgb:c099ff'
declare-option str base09 'rgb:ffc777'
declare-option str base0A 'rgb:ffc777'
declare-option str base0B 'rgb:c3e88d'
declare-option str base0C 'rgb:86e1fc'
declare-option str base0D 'rgb:82aaff'
declare-option str base0E 'rgb:fca7ea'
declare-option str base0F 'rgb:c53b53'
declare-option str base10 'rgb:1e2030'
declare-option str base11 'rgb:1a1b2a'
declare-option str base12 'rgb:ff757f'
declare-option str base13 'rgb:ffd793'
declare-option str base14 'rgb:c3e88d'
declare-option str base15 'rgb:86e1fc'
declare-option str base16 'rgb:82aaff'
declare-option str base17 'rgb:fca7ea'
