...
declare-option str base01 'rgb:f5f5f5'
declare-option str base02 'rgb:c8c8fa'
declare-option str base03 'rgb:969896'
declare-option str base04 'rgb:e8e8e8'
declare-option str base05 'rgb:333333'
declare-option str base06 'rgb:ffffff'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:ed6a43'
declare-option str base09 'rgb:0086b3'
declare-option str base0A 'rgb:795da3'
declare-option str base0B 'rgb:183691'
declare-option str base0C 'rgb:183691'
declare-option str base0D 'rgb:795da3'
declare-option str base0E 'rgb:a71d5d'
declare-option str base0F 'rgb:333333'
