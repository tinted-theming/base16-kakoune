...
declare-option str base00 'rgb:29262f'
declare-option str base01 'rgb:000000'
declare-option str base02 'rgb:323232'
declare-option str base03 'rgb:5b5b5b'
declare-option str base04 'rgb:858585'
declare-option str base05 'rgb:afafaf'
declare-option str base06 'rgb:d9d9d9'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:c37372'
declare-option str base09 'rgb:c2c372'
declare-option str base0A 'rgb:aaaadb'
declare-option str base0B 'rgb:72c373'
declare-option str base0C 'rgb:72c2c3'
declare-option str base0D 'rgb:7372c3'
declare-option str base0E 'rgb:c372c2'
declare-option str base0F 'rgb:613939'
declare-option str base10 'rgb:212121'
declare-option str base11 'rgb:101010'
declare-option str base12 'rgb:dbaaaa'
declare-option str base13 'rgb:dadbaa'
declare-option str base14 'rgb:aadbaa'
declare-option str base15 'rgb:aadadb'
declare-option str base16 'rgb:aaaadb'
declare-option str base17 'rgb:dbaada'
