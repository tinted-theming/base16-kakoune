...
declare-option str base00 'rgb:292d3e'
declare-option str base01 'rgb:444267'
declare-option str base02 'rgb:5c598b'
declare-option str base03 'rgb:676e95'
declare-option str base04 'rgb:8796b0'
declare-option str base05 'rgb:959dcb'
declare-option str base06 'rgb:959dcb'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:6e98e1'
declare-option str base09 'rgb:f78c6c'
declare-option str base0A 'rgb:e0a557'
declare-option str base0B 'rgb:78c06e'
declare-option str base0C 'rgb:83b7e5'
declare-option str base0D 'rgb:82aaff'
declare-option str base0E 'rgb:c792ea'
declare-option str base0F 'rgb:ff5370'
