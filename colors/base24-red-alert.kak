...
declare-option str base00 'rgb:762423'
declare-option str base01 'rgb:000000'
declare-option str base02 'rgb:262626'
declare-option str base03 'rgb:525252'
declare-option str base04 'rgb:7e7e7e'
declare-option str base05 'rgb:aaaaaa'
declare-option str base06 'rgb:d6d6d6'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:d52e4d'
declare-option str base09 'rgb:beb86b'
declare-option str base0A 'rgb:65a9f0'
declare-option str base0B 'rgb:71be6b'
declare-option str base0C 'rgb:6bbeb8'
declare-option str base0D 'rgb:479bed'
declare-option str base0E 'rgb:e878d6'
declare-option str base0F 'rgb:6a1726'
declare-option str base10 'rgb:191919'
declare-option str base11 'rgb:0c0c0c'
declare-option str base12 'rgb:e02453'
declare-option str base13 'rgb:dfddb7'
declare-option str base14 'rgb:aff08b'
declare-option str base15 'rgb:b7dfdd'
declare-option str base16 'rgb:65a9f0'
declare-option str base17 'rgb:ddb7df'
