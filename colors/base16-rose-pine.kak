...
declare-option str base03 'rgb:555169'
declare-option str base04 'rgb:6e6a86'
declare-option str base05 'rgb:e0def4'
declare-option str base06 'rgb:f0f0f3'
declare-option str base07 'rgb:c5c3ce'
declare-option str base08 'rgb:e2e1e7'
declare-option str base09 'rgb:eb6f92'
declare-option str base0A 'rgb:f6c177'
declare-option str base0B 'rgb:ebbcba'
declare-option str base0C 'rgb:31748f'
declare-option str base0D 'rgb:9ccfd8'
declare-option str base0E 'rgb:c4a7e7'
declare-option str base0F 'rgb:e5e5e5'
