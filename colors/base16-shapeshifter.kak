...
declare-option str base00 'rgb:f9f9f9'
declare-option str base01 'rgb:e0e0e0'
declare-option str base02 'rgb:ababab'
declare-option str base03 'rgb:555555'
declare-option str base04 'rgb:343434'
declare-option str base05 'rgb:102015'
declare-option str base06 'rgb:040404'
declare-option str base07 'rgb:000000'
declare-option str base08 'rgb:e92f2f'
declare-option str base09 'rgb:e09448'
declare-option str base0A 'rgb:dddd13'
declare-option str base0B 'rgb:0ed839'
declare-option str base0C 'rgb:23edda'
declare-option str base0D 'rgb:3b48e3'
declare-option str base0E 'rgb:f996e2'
declare-option str base0F 'rgb:69542d'
