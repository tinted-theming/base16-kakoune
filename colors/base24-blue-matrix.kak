...
declare-option str base00 'rgb:0f1115'
declare-option str base01 'rgb:101116'
declare-option str base02 'rgb:676767'
declare-option str base03 'rgb:7f7f7f'
declare-option str base04 'rgb:979797'
declare-option str base05 'rgb:afafaf'
declare-option str base06 'rgb:c7c7c7'
declare-option str base07 'rgb:feffff'
declare-option str base08 'rgb:ff567f'
declare-option str base09 'rgb:fefc57'
declare-option str base0A 'rgb:6871ff'
declare-option str base0B 'rgb:00ff9b'
declare-option str base0C 'rgb:75c1fe'
declare-option str base0D 'rgb:00b0fe'
declare-option str base0E 'rgb:d47bfe'
declare-option str base0F 'rgb:7f2b3f'
declare-option str base10 'rgb:444444'
declare-option str base11 'rgb:222222'
declare-option str base12 'rgb:ff6d67'
declare-option str base13 'rgb:fefb67'
declare-option str base14 'rgb:5ff967'
declare-option str base15 'rgb:5ffdff'
declare-option str base16 'rgb:6871ff'
declare-option str base17 'rgb:d582eb'
