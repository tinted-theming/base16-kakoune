...
declare-option str base00 'rgb:2c3e50'
declare-option str base01 'rgb:34495e'
declare-option str base02 'rgb:7f8c8d'
declare-option str base03 'rgb:95a5a6'
declare-option str base04 'rgb:bdc3c7'
declare-option str base05 'rgb:e0e0e0'
declare-option str base06 'rgb:f5f5f5'
declare-option str base07 'rgb:ecf0f1'
declare-option str base08 'rgb:e74c3c'
declare-option str base09 'rgb:e67e22'
declare-option str base0A 'rgb:f1c40f'
declare-option str base0B 'rgb:2ecc71'
declare-option str base0C 'rgb:1abc9c'
declare-option str base0D 'rgb:3498db'
