...
declare-option str base00 'rgb:0d0f18'
declare-option str base01 'rgb:222222'
declare-option str base02 'rgb:444444'
declare-option str base03 'rgb:727272'
declare-option str base04 'rgb:a1a1a1'
declare-option str base05 'rgb:d0d0d0'
declare-option str base06 'rgb:ffffff'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:ff000f'
declare-option str base09 'rgb:ffb900'
declare-option str base0A 'rgb:0092ff'
declare-option str base0B 'rgb:8ce00a'
declare-option str base0C 'rgb:00d7eb'
declare-option str base0D 'rgb:008df8'
declare-option str base0E 'rgb:6c43a5'
declare-option str base0F 'rgb:7f0007'
declare-option str base10 'rgb:2d2d2d'
declare-option str base11 'rgb:161616'
declare-option str base12 'rgb:ff273f'
declare-option str base13 'rgb:ffd141'
declare-option str base14 'rgb:abe05a'
declare-option str base15 'rgb:67ffef'
declare-option str base16 'rgb:0092ff'
declare-option str base17 'rgb:9a5feb'
