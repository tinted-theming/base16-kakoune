...
declare-option str base03 'rgb:656565'
declare-option str base04 'rgb:989898'
declare-option str base05 'rgb:cbcbcb'
declare-option str base06 'rgb:ffffff'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:da4939'
declare-option str base09 'rgb:ffd24a'
declare-option str base0A 'rgb:9fcef0'
declare-option str base0B 'rgb:519f50'
declare-option str base0C 'rgb:6e9cbe'
declare-option str base0D 'rgb:6d9cbe'
declare-option str base0E 'rgb:d0d0ff'
declare-option str base0F 'rgb:6d241c'
declare-option str base10 'rgb:212121'
declare-option str base11 'rgb:101010'
declare-option str base12 'rgb:ff7b6b'
declare-option str base13 'rgb:ffff7c'
declare-option str base14 'rgb:83d182'
declare-option str base15 'rgb:a0cef0'
declare-option str base16 'rgb:9fcef0'
declare-option str base17 'rgb:ffffff'
