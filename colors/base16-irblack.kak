...
declare-option str base01 'rgb:242422'
declare-option str base02 'rgb:484844'
declare-option str base03 'rgb:6c6c66'
declare-option str base04 'rgb:918f88'
declare-option str base05 'rgb:b5b3aa'
declare-option str base06 'rgb:d9d7cc'
declare-option str base07 'rgb:fdfbee'
declare-option str base08 'rgb:ff6c60'
declare-option str base09 'rgb:e9c062'
declare-option str base0A 'rgb:ffffb6'
declare-option str base0B 'rgb:a8ff60'
declare-option str base0C 'rgb:c6c5fe'
declare-option str base0D 'rgb:96cbfe'
declare-option str base0E 'rgb:ff73fd'
declare-option str base0F 'rgb:b18a3d'
