...
declare-option str base00 'rgb:00211f'
declare-option str base01 'rgb:003a38'
declare-option str base02 'rgb:005453'
declare-option str base03 'rgb:ababab'
declare-option str base04 'rgb:c3c3c3'
declare-option str base05 'rgb:dcdcdc'
declare-option str base06 'rgb:efefef'
declare-option str base07 'rgb:f5f5f5'
declare-option str base08 'rgb:ce7e8e'
declare-option str base09 'rgb:dca37c'
declare-option str base0A 'rgb:bfac4e'
declare-option str base0B 'rgb:56c16f'
declare-option str base0C 'rgb:62c0be'
declare-option str base0D 'rgb:88b0da'
declare-option str base0E 'rgb:b39be0'
declare-option str base0F 'rgb:d89aba'
