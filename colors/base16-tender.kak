...
declare-option str base01 'rgb:383838'
declare-option str base02 'rgb:484848'
declare-option str base03 'rgb:4c4c4c'
declare-option str base04 'rgb:b8b8b8'
declare-option str base05 'rgb:eeeeee'
declare-option str base06 'rgb:e8e8e8'
declare-option str base07 'rgb:feffff'
declare-option str base08 'rgb:f43753'
declare-option str base09 'rgb:dc9656'
declare-option str base0A 'rgb:ffc24b'
declare-option str base0B 'rgb:c9d05c'
declare-option str base0C 'rgb:73cef4'
declare-option str base0D 'rgb:b3deef'
declare-option str base0E 'rgb:d3b987'
