...
declare-option str base00 'rgb:292a37'
declare-option str base01 'rgb:343545'
declare-option str base02 'rgb:3c3e51'
declare-option str base03 'rgb:45475d'
declare-option str base04 'rgb:50526b'
declare-option str base05 'rgb:c0cbe3'
declare-option str base06 'rgb:d9e0ee'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:ec6a88'
declare-option str base09 'rgb:efb993'
declare-option str base0A 'rgb:e1c697'
declare-option str base0B 'rgb:3fdaa4'
declare-option str base0C 'rgb:ff7eb6'
declare-option str base0D 'rgb:3fc6de'
declare-option str base0E 'rgb:be95ff'
declare-option str base0F 'rgb:8b8da9'
