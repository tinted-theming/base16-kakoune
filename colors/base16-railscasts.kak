...
declare-option str base01 'rgb:272935'
declare-option str base02 'rgb:3a4055'
declare-option str base03 'rgb:5a647e'
declare-option str base04 'rgb:d4cfc9'
declare-option str base05 'rgb:e6e1dc'
declare-option str base06 'rgb:f4f1ed'
declare-option str base07 'rgb:f9f7f3'
declare-option str base08 'rgb:da4939'
declare-option str base09 'rgb:cc7833'
declare-option str base0A 'rgb:ffc66d'
declare-option str base0B 'rgb:a5c261'
declare-option str base0C 'rgb:519f50'
declare-option str base0D 'rgb:6d9cbe'
declare-option str base0E 'rgb:b6b3eb'
declare-option str base0F 'rgb:bc9458'
