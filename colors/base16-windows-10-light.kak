...
declare-option str base00 'rgb:f2f2f2'
declare-option str base01 'rgb:e5e5e5'
declare-option str base02 'rgb:d9d9d9'
declare-option str base03 'rgb:cccccc'
declare-option str base04 'rgb:ababab'
declare-option str base05 'rgb:767676'
declare-option str base06 'rgb:414141'
declare-option str base07 'rgb:0c0c0c'
declare-option str base08 'rgb:c50f1f'
declare-option str base09 'rgb:f9f1a5'
declare-option str base0A 'rgb:c19c00'
declare-option str base0B 'rgb:13a10e'
declare-option str base0C 'rgb:3a96dd'
declare-option str base0D 'rgb:0037da'
declare-option str base0E 'rgb:881798'
declare-option str base0F 'rgb:16c60c'
