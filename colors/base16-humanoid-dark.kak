...
declare-option str base00 'rgb:232629'
declare-option str base01 'rgb:333b3d'
declare-option str base02 'rgb:484e54'
declare-option str base03 'rgb:60615d'
declare-option str base04 'rgb:c0c0bd'
declare-option str base05 'rgb:f8f8f2'
declare-option str base06 'rgb:fcfcf6'
declare-option str base07 'rgb:fcfcfc'
declare-option str base08 'rgb:f11235'
declare-option str base09 'rgb:ff9505'
declare-option str base0A 'rgb:ffb627'
declare-option str base0B 'rgb:02d849'
declare-option str base0C 'rgb:0dd9d6'
declare-option str base0D 'rgb:00a6fb'
declare-option str base0E 'rgb:f15ee3'
