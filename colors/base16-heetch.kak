...
declare-option str base00 'rgb:190134'
declare-option str base01 'rgb:392551'
declare-option str base02 'rgb:5a496e'
declare-option str base03 'rgb:7b6d8b'
declare-option str base04 'rgb:9c92a8'
declare-option str base05 'rgb:bdb6c5'
declare-option str base06 'rgb:dedae2'
declare-option str base07 'rgb:feffff'
declare-option str base08 'rgb:27d9d5'
declare-option str base09 'rgb:5ba2b6'
declare-option str base0A 'rgb:8f6c97'
declare-option str base0B 'rgb:c33678'
declare-option str base0C 'rgb:f80059'
declare-option str base0D 'rgb:bd0152'
declare-option str base0E 'rgb:82034c'
declare-option str base0F 'rgb:470546'
