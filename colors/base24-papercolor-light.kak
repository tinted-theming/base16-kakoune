...
declare-option str base01 'rgb:e4e4e4'
declare-option str base02 'rgb:d0d0d0'
declare-option str base03 'rgb:878787'
declare-option str base04 'rgb:b2b2b2'
declare-option str base05 'rgb:444444'
declare-option str base06 'rgb:005f87'
declare-option str base07 'rgb:0087af'
declare-option str base08 'rgb:af0000'
declare-option str base09 'rgb:d70087'
declare-option str base0A 'rgb:5f8700'
declare-option str base0B 'rgb:008700'
declare-option str base0C 'rgb:d75f00'
declare-option str base0D 'rgb:0087af'
declare-option str base0E 'rgb:8700af'
declare-option str base0F 'rgb:005faf'
declare-option str base10 'rgb:f4f4f4'
declare-option str base11 'rgb:ffffff'
declare-option str base12 'rgb:d70000'
declare-option str base13 'rgb:ff00af'
declare-option str base14 'rgb:87af00'
declare-option str base15 'rgb:00af00'
declare-option str base16 'rgb:ff8700'
declare-option str base17 'rgb:5fafff'
