...
declare-option str base00 'rgb:0e0e0e'
declare-option str base01 'rgb:000000'
declare-option str base02 'rgb:666666'
declare-option str base03 'rgb:858585'
declare-option str base04 'rgb:a5a5a5'
declare-option str base05 'rgb:c5c5c5'
declare-option str base06 'rgb:e5e5e5'
declare-option str base07 'rgb:e5e5e5'
declare-option str base08 'rgb:cd3131'
declare-option str base09 'rgb:e5e510'
declare-option str base0A 'rgb:3b8eea'
declare-option str base0B 'rgb:0dbc79'
declare-option str base0C 'rgb:11a8cd'
declare-option str base0D 'rgb:2472c8'
declare-option str base0E 'rgb:bc3fbc'
declare-option str base0F 'rgb:661818'
declare-option str base10 'rgb:444444'
declare-option str base11 'rgb:222222'
declare-option str base12 'rgb:f14c4c'
declare-option str base13 'rgb:f5f543'
declare-option str base14 'rgb:23d18b'
declare-option str base15 'rgb:29b8db'
declare-option str base16 'rgb:3b8eea'
declare-option str base17 'rgb:d670d6'
