...
#
# Authors:
# Scheme: Cody Buell (https://github.com/codybuell)
# Template: Jamy Golden (https://github.com/JamyGolden)

# palette

declare-option str base00 'rgb:1d1f21'
declare-option str base01 'rgb:282a2e'
declare-option str base02 'rgb:373b41'
declare-option str base03 'rgb:969896'
declare-option str base04 'rgb:b4b7b4'
declare-option str base05 'rgb:c5c8c6'
declare-option str base06 'rgb:e0e0e0'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:cc6666'
declare-option str base09 'rgb:de935f'
declare-option str base0A 'rgb:f0c674'
declare-option str base0B 'rgb:b5bd68'
declare-option str base0C 'rgb:8abeb7'
declare-option str base0D 'rgb:81a2be'
declare-option str base0E 'rgb:b294bb'
declare-option str base0F 'rgb:a3685a'
declare-option str base10 'rgb:080909'
declare-option str base11 'rgb:2d3135'
declare-option str base12 'rgb:e74c3c'
declare-option str base13 'rgb:f7dc6f'
declare-option str base14 'rgb:b8d4b3'
declare-option str base15 'rgb:95d3ce'
declare-option str base16 'rgb:85c1e9'
declare-option str base17 'rgb:d7a3ca'
