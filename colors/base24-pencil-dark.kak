...
declare-option str base03 'rgb:676767'
declare-option str base04 'rgb:8d8d8d'
declare-option str base05 'rgb:b3b3b3'
declare-option str base06 'rgb:d9d9d9'
declare-option str base07 'rgb:f1f1f1'
declare-option str base08 'rgb:c30771'
declare-option str base09 'rgb:a89c14'
declare-option str base0A 'rgb:20bbfc'
declare-option str base0B 'rgb:10a778'
declare-option str base0C 'rgb:20a5ba'
declare-option str base0D 'rgb:008ec4'
declare-option str base0E 'rgb:523c79'
declare-option str base0F 'rgb:610338'
declare-option str base10 'rgb:2c2c2c'
declare-option str base11 'rgb:161616'
declare-option str base12 'rgb:fb007a'
declare-option str base13 'rgb:f3e430'
declare-option str base14 'rgb:5fd7af'
declare-option str base15 'rgb:4fb8cc'
declare-option str base16 'rgb:20bbfc'
declare-option str base17 'rgb:6855de'
