...
declare-option str base00 'rgb:263238'
declare-option str base01 'rgb:2c393f'
declare-option str base02 'rgb:37474f'
declare-option str base03 'rgb:707880'
declare-option str base04 'rgb:c9ccd3'
declare-option str base05 'rgb:cdd3de'
declare-option str base06 'rgb:d5dbe5'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:ec5f67'
declare-option str base09 'rgb:ea9560'
declare-option str base0A 'rgb:ffcc00'
declare-option str base0B 'rgb:8bd649'
declare-option str base0C 'rgb:80cbc4'
declare-option str base0D 'rgb:89ddff'
declare-option str base0E 'rgb:82aaff'
declare-option str base0F 'rgb:ec5f67'
