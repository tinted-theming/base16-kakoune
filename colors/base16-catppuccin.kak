...
declare-option str base00 'rgb:1e1e28'
declare-option str base01 'rgb:1a1826'
declare-option str base02 'rgb:302d41'
declare-option str base03 'rgb:575268'
declare-option str base04 'rgb:6e6c7c'
declare-option str base05 'rgb:d7dae0'
declare-option str base06 'rgb:f5e0dc'
declare-option str base07 'rgb:c9cbff'
declare-option str base08 'rgb:f28fad'
declare-option str base09 'rgb:f8bd96'
declare-option str base0A 'rgb:fae3b0'
declare-option str base0B 'rgb:abe9b3'
declare-option str base0C 'rgb:b5e8e0'
declare-option str base0D 'rgb:96cdfb'
declare-option str base0E 'rgb:ddb6f2'
