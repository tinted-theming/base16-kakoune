...
declare-option str base00 'rgb:181818'
declare-option str base01 'rgb:242424'
declare-option str base02 'rgb:4a4a4a'
declare-option str base03 'rgb:737373'
declare-option str base04 'rgb:9c9c9c'
declare-option str base05 'rgb:c5c5c5'
declare-option str base06 'rgb:eeeeee'
declare-option str base07 'rgb:8c00eb'
declare-option str base08 'rgb:d61b15'
declare-option str base09 'rgb:fdb40b'
declare-option str base0A 'rgb:0855fe'
declare-option str base0B 'rgb:59a413'
declare-option str base0C 'rgb:2594e0'
declare-option str base0D 'rgb:053a8c'
declare-option str base0E 'rgb:e40038'
declare-option str base0F 'rgb:6b0d0a'
declare-option str base10 'rgb:313131'
declare-option str base11 'rgb:181818'
declare-option str base12 'rgb:fb1b18'
declare-option str base13 'rgb:fdc70e'
declare-option str base14 'rgb:6ac118'
declare-option str base15 'rgb:3ea7fc'
declare-option str base16 'rgb:0855fe'
declare-option str base17 'rgb:fb004f'
