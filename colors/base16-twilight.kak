...
declare-option str base01 'rgb:323537'
declare-option str base02 'rgb:464b50'
declare-option str base03 'rgb:5f5a60'
declare-option str base04 'rgb:838184'
declare-option str base05 'rgb:a7a7a7'
declare-option str base06 'rgb:c3c3c3'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:cf6a4c'
declare-option str base09 'rgb:cda869'
declare-option str base0A 'rgb:f9ee98'
declare-option str base0B 'rgb:8f9d6a'
declare-option str base0C 'rgb:afc4db'
declare-option str base0D 'rgb:7587a6'
declare-option str base0E 'rgb:9b859d'
declare-option str base0F 'rgb:9b703f'
