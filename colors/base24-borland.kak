...
declare-option str base00 'rgb:0000a4'
declare-option str base01 'rgb:4e4e4e'
declare-option str base02 'rgb:7c7c7c'
declare-option str base03 'rgb:989898'
declare-option str base04 'rgb:b5b5b5'
declare-option str base05 'rgb:d1d1d1'
declare-option str base06 'rgb:eeeeee'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:ff6b60'
declare-option str base09 'rgb:ffffb6'
declare-option str base0A 'rgb:b5dcfe'
declare-option str base0B 'rgb:a7ff60'
declare-option str base0C 'rgb:c6c4fd'
declare-option str base0D 'rgb:96cafd'
declare-option str base0E 'rgb:ff73fd'
declare-option str base0F 'rgb:7f3530'
declare-option str base10 'rgb:525252'
declare-option str base11 'rgb:292929'
declare-option str base12 'rgb:ffb6b0'
declare-option str base13 'rgb:ffffcb'
declare-option str base14 'rgb:ceffab'
declare-option str base15 'rgb:dfdffe'
declare-option str base16 'rgb:b5dcfe'
declare-option str base17 'rgb:ff9cfe'
