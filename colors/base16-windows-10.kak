...
declare-option str base00 'rgb:0c0c0c'
declare-option str base01 'rgb:2f2f2f'
declare-option str base02 'rgb:535353'
declare-option str base03 'rgb:767676'
declare-option str base04 'rgb:b9b9b9'
declare-option str base05 'rgb:cccccc'
declare-option str base06 'rgb:dfdfdf'
declare-option str base07 'rgb:f2f2f2'
declare-option str base08 'rgb:e74856'
declare-option str base09 'rgb:c19c00'
declare-option str base0A 'rgb:f9f1a5'
declare-option str base0B 'rgb:16c60c'
declare-option str base0C 'rgb:61d6d6'
declare-option str base0D 'rgb:3b78ff'
declare-option str base0E 'rgb:b4009e'
declare-option str base0F 'rgb:13a10e'
