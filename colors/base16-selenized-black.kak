...
declare-option str base01 'rgb:252525'
declare-option str base02 'rgb:3b3b3b'
declare-option str base03 'rgb:777777'
declare-option str base04 'rgb:777777'
declare-option str base05 'rgb:b9b9b9'
declare-option str base06 'rgb:dedede'
declare-option str base07 'rgb:dedede'
declare-option str base08 'rgb:ed4a46'
declare-option str base09 'rgb:e67f43'
declare-option str base0A 'rgb:dbb32d'
declare-option str base0B 'rgb:70b433'
declare-option str base0C 'rgb:3fc5b7'
declare-option str base0D 'rgb:368aeb'
declare-option str base0E 'rgb:a580e2'
declare-option str base0F 'rgb:eb6eb7'
