...
declare-option str base00 'rgb:171726'
declare-option str base01 'rgb:22273d'
declare-option str base02 'rgb:525866'
declare-option str base03 'rgb:878d96'
declare-option str base04 'rgb:c8c8c8'
declare-option str base05 'rgb:ffffff'
declare-option str base06 'rgb:ffffff'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:fa7883'
declare-option str base09 'rgb:ffc387'
declare-option str base0A 'rgb:ff9470'
declare-option str base0B 'rgb:98c379'
declare-option str base0C 'rgb:8af5ff'
declare-option str base0D 'rgb:6bb8ff'
declare-option str base0E 'rgb:e799ff'
