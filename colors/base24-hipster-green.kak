...
declare-option str base00 'rgb:0f0a05'
declare-option str base01 'rgb:000000'
declare-option str base02 'rgb:666666'
declare-option str base03 'rgb:7c7c7c'
declare-option str base04 'rgb:929292'
declare-option str base05 'rgb:a8a8a8'
declare-option str base06 'rgb:bfbfbf'
declare-option str base07 'rgb:e5e5e5'
declare-option str base08 'rgb:b6204a'
declare-option str base09 'rgb:bebe00'
declare-option str base0A 'rgb:0000ff'
declare-option str base0B 'rgb:00a600'
declare-option str base0C 'rgb:00a6b2'
declare-option str base0D 'rgb:246db2'
declare-option str base0E 'rgb:b200b2'
declare-option str base0F 'rgb:5b1025'
declare-option str base10 'rgb:444444'
declare-option str base11 'rgb:222222'
declare-option str base12 'rgb:e50000'
declare-option str base13 'rgb:e5e500'
declare-option str base14 'rgb:86a83e'
declare-option str base15 'rgb:00e5e5'
declare-option str base16 'rgb:0000ff'
declare-option str base17 'rgb:e500e5'
