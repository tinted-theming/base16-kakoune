...
declare-option str base00 'rgb:0d1926'
declare-option str base01 'rgb:000000'
declare-option str base02 'rgb:262626'
declare-option str base03 'rgb:525252'
declare-option str base04 'rgb:7f7f7f'
declare-option str base05 'rgb:acacac'
declare-option str base06 'rgb:d9d9d9'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:b87a7a'
declare-option str base09 'rgb:b8b87a'
declare-option str base0A 'rgb:bdbddb'
declare-option str base0B 'rgb:7ab87a'
declare-option str base0C 'rgb:7ab8b8'
declare-option str base0D 'rgb:7a7ab8'
declare-option str base0E 'rgb:b87ab8'
declare-option str base0F 'rgb:5c3d3d'
declare-option str base10 'rgb:191919'
declare-option str base11 'rgb:0c0c0c'
declare-option str base12 'rgb:dbbdbd'
declare-option str base13 'rgb:dbdbbd'
declare-option str base14 'rgb:bddbbd'
declare-option str base15 'rgb:bddbdb'
declare-option str base16 'rgb:bdbddb'
declare-option str base17 'rgb:dbbddb'
