...
declare-option str base03 'rgb:727473'
declare-option str base04 'rgb:949592'
declare-option str base05 'rgb:b6b6b1'
declare-option str base06 'rgb:d8d8d0'
declare-option str base07 'rgb:e5e5e0'
declare-option str base08 'rgb:259d1a'
declare-option str base09 'rgb:62e456'
declare-option str base0A 'rgb:4f6a95'
declare-option str base0B 'rgb:13ce2f'
declare-option str base0C 'rgb:378ca9'
declare-option str base0D 'rgb:2424f4'
declare-option str base0E 'rgb:641e73'
declare-option str base0F 'rgb:124e0d'
declare-option str base10 'rgb:353738'
declare-option str base11 'rgb:1a1b1c'
declare-option str base12 'rgb:8dff2a'
declare-option str base13 'rgb:3afe15'
declare-option str base14 'rgb:48ff76'
declare-option str base15 'rgb:3f85a5'
declare-option str base16 'rgb:4f6a95'
declare-option str base17 'rgb:72579d'
