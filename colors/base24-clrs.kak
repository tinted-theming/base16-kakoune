...
declare-option str base03 'rgb:6b6d6a'
declare-option str base04 'rgb:838482'
declare-option str base05 'rgb:9a9b9a'
declare-option str base06 'rgb:b2b2b2'
declare-option str base07 'rgb:ededec'
declare-option str base08 'rgb:f72729'
declare-option str base09 'rgb:f96f1c'
declare-option str base0A 'rgb:156ffe'
declare-option str base0B 'rgb:32895c'
declare-option str base0C 'rgb:32c2c0'
declare-option str base0D 'rgb:125ccf'
declare-option str base0E 'rgb:9f00bc'
declare-option str base0F 'rgb:7b1314'
declare-option str base10 'rgb:383a37'
declare-option str base11 'rgb:1c1d1b'
declare-option str base12 'rgb:fb0416'
declare-option str base13 'rgb:fcd627'
declare-option str base14 'rgb:2cc631'
declare-option str base15 'rgb:39d5ce'
declare-option str base16 'rgb:156ffe'
declare-option str base17 'rgb:e800b0'
