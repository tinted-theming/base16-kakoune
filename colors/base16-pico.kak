...
declare-option str base01 'rgb:1d2b53'
declare-option str base02 'rgb:7e2553'
declare-option str base03 'rgb:008751'
declare-option str base04 'rgb:ab5236'
declare-option str base05 'rgb:5f574f'
declare-option str base06 'rgb:c2c3c7'
declare-option str base07 'rgb:fff1e8'
declare-option str base08 'rgb:ff004d'
declare-option str base09 'rgb:ffa300'
declare-option str base0A 'rgb:fff024'
declare-option str base0B 'rgb:00e756'
declare-option str base0C 'rgb:29adff'
declare-option str base0D 'rgb:83769c'
declare-option str base0E 'rgb:ff77a8'
declare-option str base0F 'rgb:ffccaa'
