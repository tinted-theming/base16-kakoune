...
#
# Authors:
# Scheme: Nguyen Nguyen (https://github.com/NLKNguyen/papercolor-theme)
...
declare-option str base02 'rgb:3a3a3a'
declare-option str base03 'rgb:808080'
declare-option str base04 'rgb:585858'
declare-option str base05 'rgb:d0d0d0'
declare-option str base06 'rgb:bcbcbc'
declare-option str base07 'rgb:c6c6c6'
declare-option str base08 'rgb:af005f'
declare-option str base09 'rgb:5faf5f'
declare-option str base0A 'rgb:d7af5f'
declare-option str base0B 'rgb:5faf00'
declare-option str base0C 'rgb:ffaf00'
declare-option str base0D 'rgb:5fafd7'
declare-option str base0E 'rgb:af87d7'
declare-option str base0F 'rgb:ff5faf'
declare-option str base10 'rgb:121212'
declare-option str base11 'rgb:080808'
declare-option str base12 'rgb:d7005f'
declare-option str base13 'rgb:87d75f'
declare-option str base14 'rgb:ffd75f'
declare-option str base15 'rgb:87d700'
declare-option str base16 'rgb:ffd700'
declare-option str base17 'rgb:87d7ff'
