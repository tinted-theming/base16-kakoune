...
declare-option str base00 'rgb:2d3743'
declare-option str base01 'rgb:000000'
declare-option str base02 'rgb:555555'
declare-option str base03 'rgb:787877'
declare-option str base04 'rgb:9b9b9a'
declare-option str base05 'rgb:bebebd'
declare-option str base06 'rgb:e1e1e0'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:ff4242'
declare-option str base09 'rgb:ffad29'
declare-option str base0A 'rgb:23d7d7'
declare-option str base0B 'rgb:74af68'
declare-option str base0C 'rgb:23d7d7'
declare-option str base0D 'rgb:338f86'
declare-option str base0E 'rgb:9413e5'
declare-option str base0F 'rgb:7f2121'
declare-option str base10 'rgb:383838'
declare-option str base11 'rgb:1c1c1c'
declare-option str base12 'rgb:ff3242'
declare-option str base13 'rgb:ffb929'
declare-option str base14 'rgb:74cd68'
declare-option str base15 'rgb:00ede1'
declare-option str base16 'rgb:23d7d7'
declare-option str base17 'rgb:ff37ff'
