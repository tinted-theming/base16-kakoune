...
declare-option str base03 'rgb:6f7170'
declare-option str base04 'rgb:8e8f8d'
declare-option str base05 'rgb:adada9'
declare-option str base06 'rgb:ccccc6'
declare-option str base07 'rgb:f8f8f2'
declare-option str base08 'rgb:f92672'
declare-option str base09 'rgb:f3fd21'
declare-option str base0A 'rgb:3f78ff'
declare-option str base0B 'rgb:4df740'
declare-option str base0C 'rgb:37c8b4'
declare-option str base0D 'rgb:2656d6'
declare-option str base0E 'rgb:8c54fe'
declare-option str base0F 'rgb:7c1339'
declare-option str base10 'rgb:353738'
declare-option str base11 'rgb:1a1b1c'
declare-option str base12 'rgb:ff5995'
declare-option str base13 'rgb:feed6c'
declare-option str base14 'rgb:b6e354'
declare-option str base15 'rgb:23ced4'
declare-option str base16 'rgb:3f78ff'
declare-option str base17 'rgb:9e6ffe'
