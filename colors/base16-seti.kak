...
declare-option str base00 'rgb:151718'
declare-option str base01 'rgb:282a2b'
declare-option str base02 'rgb:3b758c'
declare-option str base03 'rgb:41535b'
declare-option str base04 'rgb:43a5d5'
declare-option str base05 'rgb:d6d6d6'
declare-option str base06 'rgb:eeeeee'
declare-option str base07 'rgb:ffffff'
declare-option str base08 'rgb:cd3f45'
declare-option str base09 'rgb:db7b55'
declare-option str base0A 'rgb:e6cd69'
declare-option str base0B 'rgb:9fca56'
declare-option str base0C 'rgb:55dbbe'
declare-option str base0D 'rgb:55b5db'
declare-option str base0E 'rgb:a074c4'
declare-option str base0F 'rgb:8a553f'
