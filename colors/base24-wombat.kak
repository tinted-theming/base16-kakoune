...
declare-option str base00 'rgb:171717'
declare-option str base01 'rgb:000000'
declare-option str base02 'rgb:313131'
declare-option str base03 'rgb:5c5b58'
declare-option str base04 'rgb:87857f'
declare-option str base05 'rgb:b2afa6'
declare-option str base06 'rgb:ded9ce'
declare-option str base07 'rgb:fefffe'
declare-option str base08 'rgb:ff605a'
declare-option str base09 'rgb:ead89c'
declare-option str base0A 'rgb:a5c7ff'
declare-option str base0B 'rgb:b1e869'
declare-option str base0C 'rgb:82fff6'
declare-option str base0D 'rgb:5da9f6'
declare-option str base0E 'rgb:e86aff'
declare-option str base0F 'rgb:7f302d'
declare-option str base10 'rgb:202020'
declare-option str base11 'rgb:101010'
declare-option str base12 'rgb:f58b7f'
declare-option str base13 'rgb:eee5b2'
declare-option str base14 'rgb:dcf88f'
declare-option str base15 'rgb:b6fff9'
declare-option str base16 'rgb:a5c7ff'
declare-option str base17 'rgb:ddaaff'
