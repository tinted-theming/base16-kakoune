...
This template maps [Tinted Theming] Base16, Base24 and Tinted8 schemes to
...
```sh
cd $HOME/.config/kak
git clone https://github.com/tinted-theming/tinted-kakoune.git
...
In command mode, change the colorscheme in Kakoune by typing `colorscheme
base16-` and an autocomplete list of the colorschemes should appear.
